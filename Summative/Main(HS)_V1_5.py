...
class vendor(Entity):
    ...
    def __init__(self, spawnX, spawnY):
        ...
        self.AK_isBuy = False
        self.Mp40_isBuy = False
        self.M16_isBuy = False
        self.DB_isBuy = False
        self.Revolver_isBuy = False
        self.Dual_price = 150
        self.Shotgun_price = 225
        self.AK_price = 500
        self.Mp40_price = 275
        self.M16_price = 475
        self.DB_price = 350
...
def main():
    ...
    while running:
        ...
        Dosh_display = game_font.render(("$:"+str(p.Dosh)), False, (244, 235, 66))
        ...
        screen.blit(Dosh_display,(400,12))
        pygame.display.flip()
        clock.tick(60)
